...
var AsyncTaskManager = require("../../lib/async-task-manager");
//----------------------------
/**
...
describe('async-task-manager test', () => {

    it('async-task-manager correct test', done => {
        //var s = new Series();
    ...
    it('async-task-manager fail test', done => {
